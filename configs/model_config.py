...
MODEL_ROOT_PATH = "/home/zhiwang/LLM/Model"

# 选用的 Embedding 名称
EMBEDDING_MODEL = "bge-large-zh1.5"
...
LLM_MODELS = ["Yi-1.5-9B-Chat-16K","Qwen1.5-7B-Chat","Qwen1.5-0.5B-Chat","Qwen1.5-1.8B-Chat","Qwen2.5-7B-Instruct","Qwen2.5-Math-7B-Instruct","zhipu-api", "openai-api"]
Agent_MODEL = None
...
MODEL_PATH = {
    "embed_model": {
        ...
        "bge-base-zh-v1.5": "BAAI/Bbge-base-zh-v1.5",
