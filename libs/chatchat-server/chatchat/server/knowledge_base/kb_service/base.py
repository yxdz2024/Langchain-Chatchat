...
<<<<<<< HEAD:server/knowledge_base/kb_service/base.py
...
=======
        ...
        if status:
            self.do_create_kb()
>>>>>>> 40994eb6c3c8aeb9af4d52123abfb471a3f27b9c:libs/chatchat-server/chatchat/server/knowledge_base/kb_service/base.py
        return status
